...
api_id = 1426688  # Your Api ID
api_hash = '93393d94fc104d23eb65865a587c80bd'  # Your Api Hash
phone = '+85510400229'  # Your Phone Number With Country Code.
...
def add_users_to_group():
    excel_name = input('Enter exel name: ')
    input_file = excel_name
    users = []
